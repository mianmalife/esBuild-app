(() => {
  ...
  console.log(Server.renderToString(/* @__PURE__ */ React.createElement(TagDiv, null)));
  document.body.innerHTML = Server.renderToString(/* @__PURE__ */ React.createElement(TagDiv, null));
})();
/*
object-assign
(c) Sindre Sorhus
